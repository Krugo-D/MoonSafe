...
pragma solidity ^0.8.14;
    ...
    contract CowInu is Context, IERC20, Ownable {
        ...
        uint256 private _tTotal = 988000 * 10**6 * 10**9;
    ...
    event SwapAndLiquify(
       ...
       modifier lockTheSwap {
        ...
        constructor () public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // UniswapV2 for Binance smart chain network
